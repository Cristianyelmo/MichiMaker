@extends('template')
@section('title','tus sombreros')
@push('css')

@endpush
@section('admin')
<div class="">
<a href="{{route('sombreros.create')}}">
...
<a href="{{route('sombreros.edit',['sombrero'=>$sombrero])}}" class="bg-[#008000] border-black border-4 w-[30px] h-[30px]"><i class="fa-solid fa-pen-to-square"></i></a>
</div>
</div>
<!--  -->
