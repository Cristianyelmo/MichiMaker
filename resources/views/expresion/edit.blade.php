@extends('template')
@section('title','editar expresions')
@push('css')

@endpush
@section('admin')
<div class="">
  <form action="{{route('expresions.update',['expresion' => $expresions])}}" method="post" enctype='multipart/form-data'>
  @method('PATCH')
    @csrf
...
<img src="https://michimaker-production.up.railway.app/storage/img/{{$expresions->accesorio->image}}" id="uploadedImage" alt="">
</div>
...
value="{{old('nombre',$expresions->accesorio->nombre)}}">
