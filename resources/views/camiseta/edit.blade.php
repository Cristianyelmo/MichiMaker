@extends('template')
@section('title','editar camisetas')
@push('css')

@endpush
@section('admin')
<div class="">
  <form action="{{route('camisetas.update',['camiseta' => $camisetas])}}" method="post" enctype='multipart/form-data'>
  @method('PATCH')
    @csrf
...
<img src="https://michimaker-production.up.railway.app/storage/img/{{$camisetas->accesorio->image}}" id="uploadedImage" alt="">
</div>
