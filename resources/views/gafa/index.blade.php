...
<div class="border-black border-4 w-[200px] h-[200px] contenedor">
  ...
  <img src="https://michimaker-production.up.railway.app/storage/img/{{$gafa->accesorio->image}}" alt="">
</div>
...
<a href="{{route('gafas.edit',['gafa'=>$gafa])}}" class="bg-[#008000] border-black border-4 w-[30px] h-[30px]"><i class="fa-solid fa-pen-to-square"></i></a>
</div>
</div>
<!--  -->
